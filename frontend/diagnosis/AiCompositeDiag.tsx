...
import { View, Text, TouchableOpacity, ScrollView, TextInput, Platform, Image, Keyboard, ActivityIndicator } from 'react-native';
        ...
        >
            <View className="flex-1">
                ...
                >
                    ...
                    {/* Pre-canned prompts example if empty history, or just keep simple */}
                    {messages.length === 1 && (
                        <View className="flex-row items-start gap-3 max-w-[88%] mt-4">
