            ...
            <View className="items-center justify-center py-4 relative">
                <View className="relative w-52 h-52 items-center justify-center">
                    ...
                    <View className="absolute inset-0 items-center justify-center z-10">
                        <Text className="text-text-muted text-xs font-medium tracking-wide mb-1">종합 점수</Text>
                        <Text className="text-5xl font-bold text-white tracking-tighter">
                            {safetyScore}<Text className="text-xl text-text-dim font-normal">점</Text>
                        </Text>
                        <View className="mt-2 flex-row items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-success/10 border border-success/20">
                            <View className="w-1.5 h-1.5 rounded-full bg-success" />
                            <Text className="text-success text-[10px] font-bold">상태 최상</Text>
                        </View>
                    </View>
                </View>
            </View>
            ...
            <View className="px-6 mb-4">
                ...
                <View className="flex-row gap-2.5">
                    {[
                        ...
                        <TouchableOpacity
                            key={index}
                            className="flex-1 aspect-square rounded-xl bg-white/5 border border-white/10 items-center justify-center gap-2"
                            activeOpacity={0.7}
                        >
                            <MaterialIcons name={item.icon as any} size={28} color="#0d7ff2" />
